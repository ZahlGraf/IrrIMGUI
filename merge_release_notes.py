...
def writeToOutput(ReadmeFileContent, VersionString):
  ...
  File.write("\n")    
  File.write("\n")    
  File.write("### "+Date+": Version "+VersionString+" ([Download Source](https://github.com/ZahlGraf/IrrIMGUI/archive/v"+VersionString+".zip)) ([Download Binaries](http://irrimgui.netzeband.eu/binaries/irrimgui_v"+VersionString+".zip))\n")    
  File.write("\n")    
